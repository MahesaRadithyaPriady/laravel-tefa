...
<div class="py-6 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-indigo-800 mb-2">Data Pelanggaran</h1>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500">Data Pelanggaran</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <form action="" method="get" class="flex items-center">
            ...
            <div class="relative w-full">
                ...
                <input type="text" name="cari" id="cari" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5" placeholder="Cari pelanggaran...">
            </div>
        ...
        <a href="{{ route('pelanggaran.create') }}" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150">
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-indigo-50">
                    ...
                    <td class="px-6 py-4">
                        <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full">{{ $pelanggaran->poin }}</span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('pelanggaran.edit', $pelanggaran->id) }}" class="px-2 py-1 bg-indigo-500 text-white rounded hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition ease-in-out duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
                            
                            <form onsubmit="return confirm('Apakah Anda Yakin?');" action="{{ route('pelanggaran.destroy', $pelanggaran->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
