...
class AdminController extends Controller
{
    ...
    public function top10Pelanggaran(){
        $hitung = DB::table('detail_pelanggarans')->join('pelanggarans','detail_pelanggarans.id_pelanggaran', '=' ,'pelanggarans.id')->select('detail_pelanggarans.*','pelanggarans.*',DB::raw('COUNT(pelanggarans.jenis) as totals'))->groupBy('detail_pelanggarans.id','pelanggarans.id','pelanggarans.jenis')->orderByRaw('totals DESC')->take(10)->get();
