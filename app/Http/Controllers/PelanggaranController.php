...
class PelanggaranController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('pelanggaran.index')->with(['succes' => 'Pelanggaran berhasil ditambahkan']);
    }
    ...
    public function update(Request $request, $id): RedirectResponse {
        ...
        return redirect()->route('pelanggaran.index', $id)->with(['success' => 'Pelanggaran berhasil diupdate']);
    }
